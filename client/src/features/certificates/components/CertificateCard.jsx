      ...
      <div className="flex items-center gap-4">
        ...
        <div className="text-right">
          ...
          <div className="mt-2 flex gap-2 justify-end">
            <button onClick={() => onView?.(certificate)} className="px-3 py-1 bg-white dark:bg-[#11121a] border border-gray-200 dark:border-[#222436] text-xs rounded text-gray-700 dark:text-gray-100">View</button>
            <button onClick={() => onDownload?.(certificate)} className="px-3 py-1 bg-blue-600 text-white text-xs rounded">Download</button>
          </div>
        </div>
      </div>
    </div>
