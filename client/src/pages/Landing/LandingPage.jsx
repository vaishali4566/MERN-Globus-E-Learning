    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-32">
        ...
        <section className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              <button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-medium">
                Get Started <FiArrowRight />
              </button>

              <button className="flex items-center gap-2 border dark:border-gray-700 px-6 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-darkHover">
                <FiPlay /> Watch Demo
              </button>
            </div>
          </div>
        ...
        <section className="bg-blue-600 dark:bg-blue-500 rounded-3xl px-6 py-14 text-center text-white space-y-4">
          ...
          <button className="bg-white text-blue-600 font-medium px-6 py-3 rounded-xl hover:bg-gray-100">
            Enroll Now
          </button>
        </section>
