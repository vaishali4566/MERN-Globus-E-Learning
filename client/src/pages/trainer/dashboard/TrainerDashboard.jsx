      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {upcomingClasses.map((cls, i) => (
                ...
                >
                  ...
                  <button className="text-xs text-red-500">⏰ Remind me</button>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-white dark:bg-[#1f2337] rounded-xl p-4 shadow space-y-2">
            ...
            <button className="w-full bg-purple-500 text-white px-4 py-2 rounded-lg text-sm flex items-center gap-2 justify-center">
